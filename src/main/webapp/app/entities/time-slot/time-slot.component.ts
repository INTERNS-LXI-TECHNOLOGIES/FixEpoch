...
export class TimeSlotComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.timeSlotService
      ...
      .subscribe(
        (res: HttpResponse<ITimeSlot[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTimeSlots(): void {
    this.eventSubscriber = this.eventManager.subscribe('timeSlotListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITimeSlot[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
