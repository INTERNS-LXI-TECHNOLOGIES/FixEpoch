...
import { ProvidedServiceComponent } from 'app/entities/provided-service/provided-service.component';
...
describe('Component Tests', () => {
  describe('ProvidedService Management Component', () => {
    let comp: ProvidedServiceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProvidedServiceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.providedServices && comp.providedServices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
