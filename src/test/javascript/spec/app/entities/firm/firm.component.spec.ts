...
import { FirmComponent } from 'app/entities/firm/firm.component';
import { FirmService } from 'app/entities/firm/firm.service';
import { Firm } from 'app/shared/model/firm.model';

describe('Component Tests', () => {
  describe('Firm Management Component', () => {
    let comp: FirmComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FirmComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.firms && comp.firms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
